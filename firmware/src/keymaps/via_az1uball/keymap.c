...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		...
		KC_LSFT, KC_A,       KC_S,               KC_D,    KC_F,                 KC_G,            KC_H,         KC_J,                  KC_K,                  LT(2,KC_L), MT(MOD_RSFT, KC_SCLN), MT(MOD_RSFT, KC_QUOT),
		KC_LCTL, KC_Z,       MT(MOD_LSFT, KC_X), KC_C,    KC_V,                 KC_B,            KC_N,         KC_M,                  MT(MOD_RGUI, KC_COMM), KC_DOT,     KC_UP,                 KC_BTN3,
		MO(1),   KC_LGUI,                        KC_LALT, MT(MOD_LCTL, KC_TAB), LT(1,KC_SPC),    LT(2,KC_ENT), MT(MOD_RALT, KC_SLSH), KC_RCTL,               KC_LEFT,    KC_DOWN,               KC_RGHT
	),
